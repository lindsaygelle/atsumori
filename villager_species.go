...
var _ json.Marshaler = VillagerSpecies(0)
...
// MarshalJSON returns the encoding of VillagerSpecies.
func (v VillagerSpecies) MarshalJSON() ([]byte, error) {
