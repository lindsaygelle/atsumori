...
var _ json.Marshaler = VillagerFlooring(0)
...
// MarshalJSON returns the encoding of VillagerFlooring.
func (v VillagerFlooring) MarshalJSON() ([]byte, error) {
