...
var (
	...
	carrieFurniture     = villagersFurniture{[]VillagerFurniture{villagerFurniturePotRack, villagerFurniturePaintingSet, villagerFurnitureAirConditioner, villagerFurnitureClawFootTub, villagerFurnitureBabyChair, villagerFurnitureMiniFridge, villagerFurnitureDishDryingRack, villagerFurnitureBathroomTowelRack, villagerFurnitureGasRange, villagerFurnitureBathroomSink, villagerFurnitureIronwoodCupboard, villagerFurnitureWoodenChest, villagerFurnitureRedDottedRug, villagerFurnitureSimpleKettle, villagerFurnitureMicrowave, villagerFurnitureRiceCooker, villagerFurnitureModelingClay, villagerFurnitureWoodenDoubleBed, villagerFurnitureWoodenEndTable, villagerFurnitureClothesCloset, villagerFurnitureOldFashionedAlarmClock, villagerFurnitureShowerSet}}
	...
	carrieMusic         = villagersMusic{villagerMusicILoveYou}
